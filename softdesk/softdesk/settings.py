...
SECRET_KEY = 'django-insecure-eixtjyphqxih(4d-b#^z(5evie8tqa2ks_fm9nl-@2parueh_('
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API for managing projects, issues, and comments for SoftDesk Support application.',
    'VERSION': '1.0.0',
